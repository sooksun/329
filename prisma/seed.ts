...
const committeeSeeds = [
  ["ภาพรวมโครงการ", "ประธานโครงการ", "ปธ", 180000],
  ["คณะกรรมการและบทบาท", "เลขานุการโครงการ", "ลข", 120000],
  ["งบประมาณและการเงิน", "ฝ่ายการเงิน", "งป", 240000],
  ["สถานที่และผังงาน", "ฝ่ายสถานที่", "สถ", 520000],
  ["ความปลอดภัยและการแพทย์", "ฝ่ายความปลอดภัย", "ปภ", 220000],
  ["กีฬาและการแข่งขัน", "ฝ่ายกีฬา", "กฬ", 580000],
  ["พิธีการและวัฒนธรรม", "ฝ่ายพิธีการ", "พธ", 320000],
  ["อาหารและสวัสดิการ", "ฝ่ายสวัสดิการ", "อห", 340000],
  ["ประชาสัมพันธ์และสื่อสาร", "ฝ่ายประชาสัมพันธ์", "ปช", 260000],
  ["ทะเบียนและต้อนรับ", "ฝ่ายทะเบียน", "ทบ", 150000],
  ["เอกสาร รายงาน และ MIS", "ฝ่ายเอกสาร", "อก", 170000],
  ["Timeline และความเสี่ยง", "ฝ่ายติดตามงาน", "ตล", 170000],
  ["ปฏิบัติการวันงาน", "ศูนย์ประสานงานกลาง", "ศป", 260000],
  ["สรุปผลและพัฒนาปีถัดไป", "ฝ่ายรายงานผล", "สร", 130000]
] as const;
...
const taskSeeds: TaskSeed[] = [
  ...
  },
  {
    ...
    priority: "P0",
    plan: "คณะกรรมการและบทบาท",
    subtasks: ["กำหนดคณะกรรมการอำนวยการ", "กำหนดคณะกรรมการดำเนินงาน", "กำหนดฝ่ายกีฬาและการแข่งขัน", "กำหนดฝ่ายพิธีการ", "กำหนดฝ่ายสถานที่", "กำหนดฝ่ายอาหารและสวัสดิการ", "กำหนดฝ่ายความปลอดภัยและการแพทย์", "กำหนดฝ่ายงบประมาณ/การเงิน", "กำหนดฝ่ายประชาสัมพันธ์", "กำหนดฝ่ายทะเบียนและประสานทีม", "กำหนดฝ่ายเอกสารและรายงานผล"],
  ...
  {
    code: "P2-03",
    title: "ป้ายและจุดนำทาง",
    priority: "P2",
    plan: "สถานที่และผังงาน",
    subtasks: ["จัดทำป้ายทางเข้า", "จัดทำป้ายจุดลงทะเบียน", "จัดทำป้ายสนามแข่งขัน", "จัดทำป้ายห้องน้ำ", "จัดทำป้ายปฐมพยาบาล", "จัดทำป้ายจุดอาหาร", "จัดทำป้ายที่จอดรถ", "ติดตั้งป้ายก่อนวันงาน"],
    outputs: ["ไฟล์ออกแบบป้าย", "ภาพติดตั้งป้าย", "รายการค่าใช้จ่ายป้าย"],
    budget: 70000,
    risk: "Low"
  },
  {
  ...
  },
  {
    ...
    priority: "P2",
    plan: "ทะเบียนและต้อนรับ",
    subtasks: ["จัดทำรายชื่อแขก", "จัดทำหนังสือเชิญ", "กำหนดจุดรับรอง", "จัดที่นั่งแขก", "จัดเจ้าหน้าที่ต้อนรับ", "เตรียมน้ำดื่ม/อาหารว่าง", "เตรียมกำหนดการสำหรับแขก", "จัดทีมถ่ายภาพ"],
    outputs: ["รายชื่อแขก", "หนังสือเชิญ", "ภาพจุดรับรอง"],
    budget: 75000,
    risk: "Low"
  },
  {
  ...
  },
  {
    ...
    priority: "P2",
    plan: "เอกสาร รายงาน และ MIS",
    subtasks: ["หนังสือเชิญทีม", "หนังสือเชิญแขก", "คำสั่งแต่งตั้งคณะกรรมการ", "กำหนดการ", "ระเบียบการแข่งขัน", "ตารางแข่งขัน", "แบบฟอร์มลงทะเบียน", "แบบฟอร์มรายงานผลการแข่งขัน", "แบบฟอร์มสรุปค่าใช้จ่าย"],
    outputs: ["ไฟล์เอกสารทั้งหมด", "PDF ฉบับเผยแพร่", "เอกสารที่อัปโหลดในระบบ MIS"],
    budget: 40000,
    risk: "Low"
  },
  {
  ...
  {
    code: "P3-01",
    title: "จัดทำรายงานผลกีฬา",
    priority: "P3",
    plan: "สรุปผลและพัฒนาปีถัดไป",
    subtasks: ["รวบรวมผลการแข่งขันทุกประเภท", "ตรวจสอบความถูกต้อง", "สรุปทีมชนะเลิศ", "สรุปทีมรองชนะเลิศ", "จัดทำตารางเหรียญ/รางวัล", "อัปโหลดไฟล์ผลการแข่งขัน", "ประกาศผลอย่างเป็นทางการ"],
    outputs: ["รายงานผลการแข่งขัน", "ตารางรางวัล", "ไฟล์ประกาศผล"],
    risk: "Low"
  },
  {
    code: "P3-02",
    title: "ปิดงบประมาณโครงการ",
    priority: "P3",
    plan: "สรุปผลและพัฒนาปีถัดไป",
    subtasks: ["รวบรวมรายรับ", "รวบรวมรายจ่าย", "ตรวจใบเสร็จ/หลักฐานจ่าย", "เปรียบเทียบงบประมาณแผนกับใช้จริง", "ตรวจรายการเกินงบ", "สรุปยอดคงเหลือ", "จัดทำรายงานการเงิน", "เสนอคณะกรรมการรับทราบ"],
    outputs: ["รายงานการเงิน", "ใบเสร็จ/หลักฐานจ่าย", "Dashboard งบประมาณ"],
    risk: "Medium"
  },
  {
    code: "P3-03",
    title: "จัดทำรายงานสรุปโครงการ",
    priority: "P3",
    plan: "สรุปผลและพัฒนาปีถัดไป",
    subtasks: ["รวบรวมภาพกิจกรรม", "รวบรวมเอกสารประกอบ", "รวบรวมรายงานแต่ละฝ่าย", "สรุปปัญหาและอุปสรรค", "สรุปข้อเสนอแนะ", "สร้าง PowerPoint รายงานผล", "สร้าง PDF รายงานฉบับสมบูรณ์", "เก็บเป็นคลังความรู้ปีถัดไป"],
    outputs: ["PowerPoint สรุปผล", "PDF รายงานผล", "Gallery ภาพกิจกรรม"],
    risk: "Low"
  },
  {
    code: "P3-04",
    title: "ประชุม After Action Review",
    priority: "P3",
    plan: "สรุปผลและพัฒนาปีถัดไป",
    subtasks: ["เชิญหัวหน้าฝ่ายประชุมสรุป", "วิเคราะห์สิ่งที่ทำได้ดี", "วิเคราะห์สิ่งที่ต้องปรับปรุง", "วิเคราะห์ปัญหาระบบงาน", "วิเคราะห์งบประมาณ", "วิเคราะห์ความเสี่ยงที่เกิดจริง", "บันทึกข้อเสนอแนะปีถัดไป", "สร้าง Template โครงการปีถัดไป"],
    outputs: ["รายงาน AAR", "รายการข้อเสนอแนะ", "Template ปีถัดไป"],
    risk: "Low"
  }
];
...
async function main() {
  ...
  for (const group of committeeUserSeeds) {
    ...
    for (const seedUser of group.users) {
      ...
      if (group.committeeName === "งบประมาณและการเงิน") {
  ...
  const project = await prisma.project.create({
    data: {
      ...
      planned_budget: committeeSeeds.reduce((sum, item) => sum + item[3], 0),
      actual_budget: 0,
  ...
  for (let i = 0; i < committeeSeeds.length; i++) {
    const [name, ownerLabel, initials, budget] = committeeSeeds[i];
    ...
    const committee = await prisma.committee.create({
      data: {
        ...
        sort_order: i + 1,
        risk_level: i < 5 || name.includes("Timeline") ? "High" : "Medium",
  ...
  for (let i = 0; i < taskSeeds.length; i++) {
    ...
    const { start, due } = scheduleTaskWindow(seed.priority, i, seed.plan);
  ...
  const summary = {
    ...
    budgetSummary: {
      planned: committeeSeeds.reduce((sum, item) => sum + item[3], 0),
  ...
  console.log("\n=== บัญชีผู้ใช้ 329 MIS (30 คน) ===");
  console.log("ผู้ดูแล: admin / admin123");
  console.log("ประธาน: director / password123");
  console.log(`สมาชิกฝ่าย (28 คน): รหัสผ่านเริ่มต้น ${DEFAULT_MEMBER_PASSWORD}`);
  console.log("ตัวอย่าง: kl_lead, kl_staff, st_lead, ng_staff ... (ดู prisma/user-seeds.ts)");
